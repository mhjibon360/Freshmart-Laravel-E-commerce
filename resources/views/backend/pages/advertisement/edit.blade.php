        ...
        <div class="row mb-8">
            <div class="col-md-12">
                <div class="d-md-flex justify-content-between align-items-center">
                    <!-- page header -->
                    <div>
                        <h2 class=" text-capitalize">advertisement</h2>
                        <!-- breacrumb -->
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item"><a href="javascript::void();"
                                        class="text-inherit">advertisement</a>
                                </li>
                    ...
                    <div>
                        <a href="{{ route('admin.advertisement.index') }}" class="btn btn-light">Back to advertisement</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <form action="{{ route('admin.advertisement.update',$advertisement->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card mb-6 shadow border-0">
                        ...
                        <div class="card-body p-6">
                            <h4 class="mb-5 h5">advertisement Image</h4>
                            <div class="mb-4 d-flex">
                                <div class="position-relative">
                                    <img class="image icon-shape icon-xxxl bg-light rounded-4"
                                        src="{{ asset($advertisement->image) }}" alt="Image" />
                            ...
                            <h4 class="mb-4 h5 mt-5">advertisement Information</h4>

                            <div class="row">
                                <!-- input -->
                                <div class="mb-3 col-lg-6">
                                    <label class="form-label text-capitalize" for="discount_title">advertisement discount
                                        title</label>
                                    <input type="text" class="form-control" id="discount_title" name="discount_title"
                                        value="{{ $advertisement->discount_title }}" />
                                ...
                                <!-- input -->
                                <div class="mb-3 col-lg-6">
                                    <label class="form-label text-capitalize" for="heading">advertisement Heading</label>
                                ...
                                <div class="mb-3 col-lg-12">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="status" id="inlineRadio1"
                                            value="1" {{ $advertisement->status == 1 ? 'checked' : '' }} />
                                        <label class="form-check-label" for="inlineRadio1">Active</label>
                                    </div>
                                    <!-- input -->
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="status" id="inlineRadio2"
                                            value="0" {{ $advertisement->status == 0 ? 'checked' : '' }} />
