        ...
        <div class="row mb-8">
            <div class="col-md-12">
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-4">
                    ...
                    <!-- button -->
                    <div>
                        <a href="{{ route('admin.advertisement.create') }}" class="btn btn-primary">Add New advertisement</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="table-responsive p-4">
                            <table id="example"
                                ...
                                <tbody>
                                    @foreach ($alladvertisement as $item)
                                        <tr>
                                            <td>{{ $loop->index + 1 }} </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item" href="{{ route('admin.advertisement.edit',$item->id) }}">
    ...
    <script>
        $(function() {
            $('.toggle-class').change(function() {
                ...
                $.ajax({
                    type: "POST",
                    url: route('admin.advertisement.status'),
                    data: {
                        status: status,
                        id: id,
                    },
