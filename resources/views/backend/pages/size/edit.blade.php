...
@section('title', 'edit new product size')
@section('content')
    <!-- container -->
    <div class="container">
        <!-- row -->
                    ...
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">edit New product size</li>
                            </ol>
                        </nav>
                    </div>
                    <div>
        ...
        <div class="row">
            <div class="col-lg-12 col-12">
                <form action="{{ route('admin.product-size.update', $size->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <!-- card -->
                            ...
                            <div class="row">
                                <div class="mb-3 col-lg-12">
                                    ...
                                    <input type="text" id="size_name" class="form-control" placeholder="size name"
                                        name="size_name" value="{{ $size->size_name }}" />
                                    @error('size_name')
