    ...
    <div class="row mb-8">
        <div class="col-md-12">
            ...
            <div class="card bg-light border-0 rounded-4"
                style="background-image: url({{ asset('backend') }}/assets/images/slider/slider-image-1.jpg); background-repeat: no-repeat; background-size: cover; background-position: right">
                        ...
                        <div class="mb-5">
                            ...
                            <div>
                                ...
                                <div class="progress bg-light-primary" style="height: 6px">
                                    <div class="progress-bar bg-primary" role="progressbar" aria-label="Example 1px high"
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <div class="progress bg-light-danger" style="height: 6px">
                                    <div class="progress-bar bg-danger" role="progressbar" aria-label="Example 1px high"
