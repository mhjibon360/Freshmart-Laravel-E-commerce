...
@section('title', 'edit new blog-post')
@section('content')
    <!-- container -->
    <div class="container">
        <!-- row -->
        <div class="row mb-8">
            <div class="col-md-12">
                <div class="d-md-flex justify-content-between align-items-center">
                    <!-- page header -->
                    <div>
                        <h2 class=" text-capitalize">edit New blog-post </h2>
                        <!-- breacrumb -->
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><a href="javascript::void();"
                                        class="text-inherit">edit New blog-post </a></li>
                            </ol>
                        </nav>
                    </div>
                    <div>
                        <a href="{{ route('admin.blog-post.index') }}" class="btn btn-light">Back to blog-post
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12 col-12">
                    ...
                    <div class="card mb-6 card-lg">
                        ...
                        <div class="card-body p-6">
                            <h4 class="mb-4 h5">blog-post Information</h4>
                            <div class="row">
                                <!-- input -->
                                <div class="mb-3 col-lg-12">
                                    <label class="form-label text-capitalize" for="category_id">blog-post Category
                                    </label>
                                ...
                                <div class="mb-3 col-lg-12 mt-5">
                                    <!-- heading -->
                                    <h4 class="mb-3 h5">blog-post Thumbnail</h4>
                                    <div class="mb-4 d-flex">
                                        <div class="position-relative">
                                            <img class="image icon-shape icon-xxxl bg-light rounded-4"
                                                src="{{ asset($blog->image) }}" alt="Image" />
                                ...
                                <!-- input -->
                                <div class="mb-3 col-lg-12 mt-5">
                                    <h4 class="mb-3 h5">blog-post Descriptions</h4>
                                    <textarea name="details" id="editor" class=" form-control" rows="5">{!! $blog->details !!}</textarea>
                                    @error('details')
                                        <span class=" text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
