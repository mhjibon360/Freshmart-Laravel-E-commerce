    <div class="col-lg-8 col-md-7">
        <div class="py-3">
            ...
            <ul class="list-group list-group-flush cart_page_product_holder" id="cart_page_product_holder">
                {{-- <hr>
                <!-- list group -->
            ...
            <div class="d-flex justify-content-between mt-4">
                ...
                <a type="button" onclick="clearCart()" class="btn btn-dark">Clear Cart</a>
            </div>
        </div>
    </div>
