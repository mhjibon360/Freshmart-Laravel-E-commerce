         ...
         <div class="col">
             ...
             <div class="card card-product">
                 <div class="card-body">
                     ...
                     <h2 class="fs-6"><a href="shop-single.html" class="text-inherit text-decoration-none">Haldiram's
                             Sev Bhujia</a></h2>
                     <div>
                         <!-- rating -->
         ...
         <div class="col">
             ...
             <div class="card card-product">
                 <div class="card-body">
                     ...
                     <h2 class="fs-6"><a href="shop-single.html" class="text-inherit text-decoration-none">Cadbury
                             5 Star Chocolate</a></h2>
                     <div class="text-warning">
                         <!-- rating -->
                         <small>
                             <i class="bi bi-star-fill"></i>
         ...
         <div class="col">
             ...
             <div class="card card-product">
                 <div class="card-body">
                     ...
                     <h2 class="fs-6"><a href="shop-single.html" class="text-inherit text-decoration-none">Onion
                             Flavour Potato</a></h2>
                     <div class="text-warning">
                         <!-- rating -->
                         <small>
         ...
         <div class="col">
             ...
             <div class="card card-product">
                 <div class="card-body">
                     ...
                     <h2 class="fs-6"><a href="shop-single.html" class="text-inherit text-decoration-none">Salted
             ...
             <div class="card card-product">
                 <div class="card-body">
                     ...
                     <div class="text-center position-relative">
                         ...
                         <a href="shop-single.html">
                             <!-- img -->
                             <img src="{{ asset('frontend') }}/assets/images/products/product-img-6.jpg"
                                 alt="Grocery Ecommerce Template" class="mb-3 img-fluid" />
                         </a>
                         <!-- action btn -->
                         <div class="card-product-action">
         ...
         <div class="col">
             ...
             <div class="card card-product">
                 <div class="card-body">
                     ...
                     <h2 class="fs-6"><a href="shop-single.html" class="text-inherit text-decoration-none">Slurrp
         ...
         <div class="col">
             ...
             <div class="card card-product">
                 <div class="card-body">
                     ...
                     <h2 class="fs-6"><a href="shop-single.html" class="text-inherit text-decoration-none">Amul
                             Butter - 500 g</a></h2>
                     <div class="text-warning">
                         <!-- rating -->
                         <small>
