                 ...
                 <div class="col-lg-5 text-lg-start text-center mb-2 mb-lg-0">
                     <ul class="list-inline mb-0">
                         ...
                         <li class="list-inline-item">
                             <a href="#!"><img src="{{ asset('frontend') }}/assets/images/payment/amazonpay.svg"
                                     alt="" /></a>
                         </li>
                         <li class="list-inline-item">
                             <a href="#!"><img
                         ...
                         <li class="list-inline-item">
                             <a href="#!"><img src="{{ asset('frontend') }}/assets/images/payment/mastercard.svg"
                                     alt="" /></a>
                         </li>
                         <li class="list-inline-item">
                             <a href="#!"><img src="{{ asset('frontend') }}/assets/images/payment/paypal.svg"
                                     alt="" /></a>
                         </li>
                         <li class="list-inline-item">
