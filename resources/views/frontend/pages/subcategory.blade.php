...
@section('title', 'subcategory ' . $subcategory->subcategory_name)
@section('main')
    <div class="mt-4">
        <div class="container">
            <!-- row -->
                ...
                <div class="col-12">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ $subcategory->subcategory_slug }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card mb-4 bg-light border-0">
                        ...
                        <div class="card-body p-9">
                            <!-- title -->
                            <h2 class="mb-0 fs-1">{{ $subcategory->subcategory_name }}</h2>
                        </div>
                    </div>
                    <!-- list icon -->
                    <div class="d-lg-flex justify-content-between align-items-center">
                        <div>
                            <p class="mb-3 mb-md-0">
                                <span class="text-dark">{{ count($subcategoryproducts) }}</span>
                                Products found
                            </p>
                        </div>
                        <!-- icon -->
                                ...
                                <div class="card card-product">
                                    <div class="card-body">
                                        ...
                                        <div class="text-small mb-1">
                                            <a href="#!"
                                                class="text-decoration-none text-muted"><small>{{ $product->subcategory->subcategory_name }}</small></a>
                                        </div>
                                        <h2 class="fs-6"><a
