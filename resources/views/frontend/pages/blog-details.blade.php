            ...
            <div class="container">
               <div class="row">
                  <div class="col-md-8 offset-md-2">
                     ...
                     <!-- img -->
                     <div class="mb-8"><img src="{{ asset('frontend') }}/assets/images/blog/blogImage.jpg" alt="" class="img-fluid rounded" /></div>
                     ...
                     <div>
                        ...
                        <div class="mb-5">
                           ...
                           <div class="d-flex align-items-start mt-4">
                              <!-- Img  -->
                              <img src="{{ asset('frontend') }}/assets/images/blog/left-img.jpg" alt="" class="img-fluid me-4 d-none d-lg-block d-md-block rounded" />
                              <div>
                        ...
                        <div class="mb-4">
                           <div class="d-flex align-items-start">
                              ...
                              <img src="{{ asset('frontend') }}/assets/images/blog/right-img.jpg" alt=" " class="img-fluid ms-4 d-none d-lg-block d-md-block rounded" />
                           </div>
                        </div>
                        <div class="mb-4">
                     ...
                     <div class="d-flex justify-content-between align-items-center mb-5">
                        <div class="d-flex align-items-center">
                           <img src="{{ asset('frontend') }}/assets/images/avatar/avatar-4.jpg" alt="" class="rounded-circle avatar-md" />
                           <div class="ms-2 lh-1">
